...
module.exports = defineConfig({
  ...
  devServer: {
    ...
    host: "wxmp.hwagain.com",
    port: 80,
    https: false,
    proxy: {
      "/apitest": {
        target: "https://www.hwagain.cn/api/hwagain-campus-recruit-pro",
        // target: "https://www.hwagain.cn/apitest/hwagain-campus-recruit",
        changeOrigin: true,
        pathRewrite: {
          "^/apitest": "",
        },
